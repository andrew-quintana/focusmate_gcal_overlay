...
### 4.  prompt_phase_X.md (Prompts for Executing Phases of TODO.md)
**Purpose**: Map for accessing information relevant for executing phases of TODO.md
- **Naming Convention**: `prompt_phase_{phase_number}.md` (e.g., `prompt_phase_1.md`, `prompt_phase_2.md`)
...
2. **prompts/**: Contains phase execution prompts
   - **prompt_phase_X.md**: One prompt file per phase from TODO.md
...
- **prompt_phase_{X}.md** - Phase execution prompts (e.g., `prompt_phase_1.md`, `prompt_phase_2.md`)

**Phase Prompt Naming Convention**:
- Format: `prompt_phase_{phase_number}.md`
- Phase number: The phase number from TODO.md (0, 1, 2, etc.)
- Examples:
  - Phase 1: `prompt_phase_1.md`
  - Phase 2: `prompt_phase_2.md`
  - Phase 0: `prompt_phase_0.md`

This enables:
- **Version tracking**: Clear progression of requirements and designs (for PRD/RFC/TODO with serials)
- **Iteration management**: Multiple approaches can be explored in parallel (for PRD/RFC/TODO)
- **Reference stability**: Links between documents remain valid as new versions are created
- **Flexible numbering**: Serial numbers can be specified or auto-detected based on existing files (for PRD/RFC/TODO)
- **Phase organization**: Phase prompts are clearly organized by phase number